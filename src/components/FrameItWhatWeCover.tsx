        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12">
            {coverItems.map((item, index) => (
              <div
                key={index}
                className="group bg-white rounded-xl p-6 text-center hover:bg-gold-50 transition-all duration-300 hover:shadow-lg hover:scale-105 border border-cream-300/50"
              >
                <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-gold-400 to-gold-600 text-white rounded-lg mb-4 group-hover:scale-110 transition-transform duration-300">
          ...
          {/* Special note */}
          <div className="bg-gradient-to-r from-gold-500/10 to-wood-500/10 rounded-2xl p-8 text-center border border-gold-500/20">
